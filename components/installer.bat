...
:: echo 10586 %1 %2
:: ------------------
:: %1    -    Code lines to execute
:: %2    -    Set the status to one of the following
:: -----------------------------------------------
:: 0      Encountered an error  10586 0 "error description"
::
:: 1      Executing the code  10586 1
::
:: 1_%~2  Indicates the next line to execute  10586 1 36
::
:: 2      Success  10586 2
:: -----------------------------------------------
...
Powershell -C "(Get-Command).name" > %~1\commands.txt :: Temporary directory path
findstr /X /C:"Get-Date" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Get-Volume" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Get-Partition" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"New-Partition" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Resize-Partition" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Remove-Partition" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Get-CimInstance" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Get-PartitionSupportedSize" Temp\Commands.txt >nul || echo 10586_1928
findstr /X /C:"Add-PartitionAccessPath" Temp\Commands.txt >nul || echo 10586_1928
